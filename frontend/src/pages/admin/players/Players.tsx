  ...
  return (
    <div className="space-y-5 max-w-5xl">
      ...
      <input
        ...
        className="w-full max-w-sm rounded-lg bg-gray-800 border border-gray-700 px-3 py-2 text-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500"
      />
