...
export default function BarNav() {
  ...
  return (
    <nav className="sticky top-0 z-40 bg-gray-900 text-white border-b border-gray-700 px-4 py-2 flex items-center gap-3">
      {/* Left: label */}
      ...
      {/* Mode switcher */}
      <div className="flex items-center gap-1 border border-gray-600 rounded-lg overflow-hidden text-xs font-semibold">
